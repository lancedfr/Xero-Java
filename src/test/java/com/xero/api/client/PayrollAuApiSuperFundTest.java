...
public class PayrollAuApiSuperFundTest {
    ...
    public void getSuperFundsTest() throws IOException {
        ...
        SuperFunds response = payrollAuApi.getSuperfunds(accessToken, xeroTenantId, null, null, null, null);
    ...
    public void getSuperFundTest() throws IOException {
        ...
        assertThat(response.getSuperFunds().get(0).getSuperFundID(), is(equalTo(UUID.fromString("540f4327-dda2-4b36-9c2f-2fe1c93a72b5"))));        
        assertThat(response.getSuperFunds().get(0).getType(), is(equalTo(com.xero.models.payrollau.SuperFundType.SMSF)));
    ...
    public void createSuperfundTest() throws IOException {
        ...
        assertThat(response.getSuperFunds().get(0).getSuperFundID(), is(equalTo(UUID.fromString("e02e44eb-2dba-4d5e-84da-8a0c3a4a4fef"))));        
        assertThat(response.getSuperFunds().get(0).getType(), is(equalTo(com.xero.models.payrollau.SuperFundType.REGULATED)));
    ...
    public void updateSuperfundTest() throws IOException {
        ...
        UUID superFundId = UUID.fromString("cdfb8371-0b21-4b8a-8903-1024df6c391e");
        List<SuperFund> superFunds = new ArrayList<>();        
        SuperFunds response = payrollAuApi.updateSuperfund(accessToken, xeroTenantId, superFundId, superFunds);
