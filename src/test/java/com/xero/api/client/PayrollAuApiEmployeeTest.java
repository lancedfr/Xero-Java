...
public class PayrollAuApiEmployeeTest {
    ...
    public void getEmployeesTest() throws IOException {
        ...
        Employees response = payrollAuApi.getEmployees(accessToken, xeroTenantId, null, null, null, null);
    ...
    public void createEmployeeTest() throws IOException {
        ...
        assertThat(response.getEmployees().get(0).getIsAuthorisedToApproveTimesheets(), is(equalTo(true)));
    ...
    public void getEmployeeTest() throws IOException {
        ...
        assertThat(response.getEmployees().get(0).getJobTitle(), is(equalTo("Regional Manager")));
        assertThat(response.getEmployees().get(0).getClassification(), is(equalTo("corporate")));
        assertThat(response.getEmployees().get(0).getPayrollCalendarID(), equalTo(UUID.fromString("78bb86b9-e1ea-47ac-b75d-f087a81931de")));
        ...
        assertThat(response.getEmployees().get(0).getPayTemplate().getLeaveLines().get(0).getLeaveTypeID(), is(equalTo(UUID.fromString("184ea8f7-d143-46dd-bef3-0c60e1aa6fca"))));
        assertThat(response.getEmployees().get(0).getPayTemplate().getLeaveLines().get(0).getCalculationType(), is(equalTo(com.xero.models.payrollau.LeaveLineCalculationType.FIXEDAMOUNTEACHPERIOD)));
        ...
        // TAX DECLARATION
        assertThat(response.getEmployees().get(0).getTaxDeclaration().getAustralianResidentForTaxPurposes(), is(equalTo(true)));
        assertThat(response.getEmployees().get(0).getTaxDeclaration().getTaxFreeThresholdClaimed(), is(equalTo(true)));   
