...
public class AccountingApiQuotesTest {
	...
	public void testGetQuotes() throws Exception {
        ...
        assertThat(quotes.getQuotes().get(0).getTerms(), is(equalTo("Not valid after the expiry date")));
        assertThat(quotes.getQuotes().get(0).getContact().getContactID(),  is(equalTo(UUID.fromString("060816db-0ed7-44de-ab58-8fee9316fcd5"))));
        ...
        assertThat(quotes.getQuotes().get(0).getLineItems().get(0).getDiscountRate(), is(equalTo(10.0)));        
        assertThat(quotes.getQuotes().get(0).getLineItems().get(0).getTracking().get(0).getTrackingCategoryID() ,  is(equalTo(UUID.fromString("351953c4-8127-4009-88c3-f9cd8c9cbe9f"))));
	...
	public void testGetQuote() throws Exception {
        ...
        assert(quotes.getQuotes().size() == 1);
		assertThat(quotes.getQuotes().get(0).getQuoteID(), is(equalTo(UUID.fromString("1f90e77a-7b88-4462-874f-1aa675be8fef"))));
        ...
        assertThat(quotes.getQuotes().get(0).getContact().getContactID(),  is(equalTo(UUID.fromString("4bc3ecb2-8e2a-4267-a171-0e0ce7e5ac2a"))));
        ...
        assertThat(quotes.getQuotes().get(0).getLineItems().get(0).getTracking().get(0).getTrackingCategoryID() ,  is(equalTo(UUID.fromString("9bd3f506-6d91-4625-81f0-0f9147f099f4"))));
	...
	public void testUpdateQuote() throws Exception {
        ...
        assert(quotes.getQuotes().size() == 1);
		assertThat(quotes.getQuotes().get(0).getQuoteID(), is(equalTo(UUID.fromString("8ce6b14c-ef87-4f45-93f0-853137c6d0e1"))));
        assertThat(quotes.getQuotes().get(0).getQuoteNumber(), is(equalTo("QU-0008")));
        assertThat(quotes.getQuotes().get(0).getReference(), is(equalTo("I am an update")));
        assertThat(quotes.getQuotes().get(0).getContact().getContactID(),  is(equalTo(UUID.fromString("8ed7dd03-4e6a-4078-a807-c5309abfec52"))));
