...
public class AccountingApiOverpaymentsTest {
    ...
    public void createOverpaymentAllocationsTest() throws IOException {
        ...
        assertThat(response.getAllocations().get(0).getDateAsDate(), is(equalTo(LocalDate.of(2019,03,12))));  
    ...
    public void getOverpaymentTest() throws IOException {
        ...
        assertThat(response.getOverpayments().get(0).getUpdatedDateUTCAsDate(), is(equalTo(OffsetDateTime.parse("2019-03-12T22:15:52.890Z"))));
        ...
        assertThat(response.getOverpayments().get(0).getAllocations().get(0).getDateAsDate(), is(equalTo(LocalDate.of(2019,03,12))));
    ...
    public void getOverpaymentsTest() throws IOException {
        ...
        assertThat(response.getOverpayments().get(0).getUpdatedDateUTCAsDate(), is(equalTo(OffsetDateTime.parse("2019-03-12T22:08:55.123Z"))));
        assertThat(response.getOverpayments().get(0).getCurrencyCode(), is(equalTo(com.xero.models.accounting.CurrencyCode.NZD)));
